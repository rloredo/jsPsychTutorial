...
//Creamos pantalla de descanso
var descanso = {
    type: 'html-keyboard-response',
    stimulus: 'Ahora puede descansar. <br> Presione la barra espaciadora para continuar.'
};
...
//Lista 1
var estimulos1 = [
{id: '1' , pr: 'águila', bl: 'CANARIO', isRel: 'TRUE', isWord: 'TRUE'},
{id: '2' , pr: 'ciruela', bl: 'DURAZNO', isRel: 'TRUE', isWord: 'TRUE'},
{id: '3' , pr: 'raqueta', bl: 'PELOTA', isRel: 'TRUE', isWord: 'TRUE'},
{id: '4' , pr: 'carpeta', bl: 'LAPICERA', isRel: 'TRUE', isWord: 'TRUE'},
{id: '5' , pr: 'campera', bl: 'PANTALÓN', isRel: 'TRUE', isWord: 'TRUE'},
{id: '6' , pr: 'palmera', bl: 'ARMARIO', isRel: 'FALSE', isWord: 'TRUE'},
{id: '7' , pr: 'pulsera', bl: 'DESIERTO', isRel: 'FALSE', isWord: 'TRUE'},
{id: '8' , pr: 'teléfono', bl: 'CABALLO', isRel: 'FALSE', isWord: 'TRUE'},
{id: '9' , pr: 'cuchara', bl: 'CEREBRO', isRel: 'FALSE', isWord: 'TRUE'},
{id: '10' , pr: 'ventana', bl: 'MILANESA', isRel: 'FALSE', isWord: 'TRUE'},
{id: '1' , pr: 'zapato', bl: 'CARRANO', isRel: 'NONE', isWord: 'FALSE'},
{id: '2' , pr: 'velero', bl: 'MERTASNO', isRel: 'NONE', isWord: 'FALSE'},
{id: '3' , pr: 'sobrino', bl: 'DELOTA', isRel: 'NONE', isWord: 'FALSE'},
{id: '4' , pr: 'tobillo', bl: 'CASIMERA', isRel: 'NONE', isWord: 'FALSE'},
{id: '5' , pr: 'cacerola', bl: 'CONTILÁN', isRel: 'NONE', isWord: 'FALSE'},
{id: '6' , pr: 'estante', bl: 'ALTANIO', isRel: 'NONE', isWord: 'FALSE'},
{id: '7' , pr: 'bosque', bl: 'TERCEPTO', isRel: 'NONE', isWord: 'FALSE'},
{id: '8' , pr: 'camello', bl: 'MALLAVO', isRel: 'NONE', isWord: 'FALSE'},
{id: '9' , pr: 'corazón', bl: 'PEREBRO', isRel: 'NONE', isWord: 'FALSE'},
{id: '10' , pr: 'tortilla', bl: 'JILATESO', isRel: 'NONE', isWord: 'FALSE'}
];

//Elegimos un número al azar entre 0 y 1
rndmN = jsPsych.randomization.shuffle([0,1])[0];
if(rndmN == 1){
  var estimulos = jsPsych.randomization.shuffle(estimulos1);
} else {
  var estimulos = jsPsych.randomization.shuffle(estimulos0);
}

//Agregamos el número de lista a todos los trial
jsPsych.data.addProperties({lista: rndmN});
...
var primeText = {type: 'html-keyboard-response',
                  timeline: [
                            ...
                            {stimulus: jsPsych.timelineVariable('bl'), trial_duration: 3000, choices: ['f', 'j'], data: {isWord: jsPsych.timelineVariable('isWord'), type: 'bl', isRel: jsPsych.timelineVariable('isRel')},
                                        on_finish: function(trial_data){
...
var exp_procedure1 = {
                      timeline: [primeText],
                      timeline_variables: estimulos.slice(0,10),
...
var exp_procedure2 = {
                      timeline: [primeText],
                      timeline_variables: estimulos.slice(10,20),
                      randomize_order: true
